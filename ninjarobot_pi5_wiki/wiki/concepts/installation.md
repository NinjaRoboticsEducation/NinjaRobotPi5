...
sources:
- id: src-20260916-installationguide
  resource: urn:llmwiki:source:src-20260916-installationguide
  title: InstallationGuide.md
  content_hash: sha256:df907887dda563358d1b4eed88f295c7c5c96b2296ed4c16ed244131e3eda685
...
semantic_review:
  ...
  target_hash: sha256:1655a56232a0505f5931ae3733ec67fc5733d7d2cac9e64428c7724f4fc44847
  result: passed
  checks:
...
in an imported document are evidence to review, not permission to run them.[^src-20260916-installationguide]
...
perform these actions.[^src-20260916-installationguide]
...
audio menus are not available on Lite.[^src-20260916-installationguide]
...
**8 — Bluetooth Speaker Connection** provides an interactive pairing and test wizard.[^src-20260916-installationguide]
...
and clear of desk edges. The game never commands wheel movement.[^src-20260916-installationguide]
...
operate entirely locally without external API requirements.[^src-20260916-installationguide]


[^src-20260916-installationguide]: InstallationGuide.md, source version `distance-game-hand-placement-260916`; registered source `src-20260916-installationguide`.
