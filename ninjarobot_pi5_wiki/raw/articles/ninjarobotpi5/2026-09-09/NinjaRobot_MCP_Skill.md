...
returns a text summary in terminal or web chat. NinjaRobotPi5 v1.0.0 has voice
input but no text-to-speech, so the robot does not speak the event names. An
optional fixed success face and tone may indicate completion.
