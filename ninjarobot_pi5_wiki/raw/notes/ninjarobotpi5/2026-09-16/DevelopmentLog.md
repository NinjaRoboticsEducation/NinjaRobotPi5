...
map are unchanged. Runtime project help still labels its older published evidence.
...
Public project help uses a fixed, bounded list of published sources and always
shows draft/older coverage limitations. Its current checkpoint is 12 September.
These newer full manuals are pending ingestion and are not silently promoted to
published runtime evidence. Version-1 skills remain supported; version 2 adds
