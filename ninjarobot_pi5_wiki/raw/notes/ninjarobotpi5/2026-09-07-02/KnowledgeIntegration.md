...
and raw/notes/ninjarobotpi5. Root manual navigation files were removed at the owner's request. Both project
and wiki READMEs link directly to the current full source documents. The current
...
The owner requested removal of the four root navigation documents after applying
the 11 knowledge pages and AI review records. Current source paths are maintained
in project-knowledge.json and both READMEs. Automated documentation checks require
the complete wiki sources and their direct README links, rather than root stubs.
Older source snapshots preserve the prior navigation arrangement as history.
